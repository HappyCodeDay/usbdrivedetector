package Contests.GoogleCodeJam.OversizedPancakeFlipper;
 ...
 */
public class OversizedPancakeFlipper_Partial_Solved {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File file = new File("OversizedPancakeFlipper_Partial_Solved.txt");
        file.delete();
